...
pub fn main() {
  ...
  matgen.fragment_shader += "return vec4f(textureSample(mainMap, mySampler, in.uv, 0).rgb, 1);";
  matgen.gen_frag_end();

  let mut mesh2: Object = Object::new(&eng, PLANE.to_vec(), matgen.generate_material("".to_string(), "".to_string()), engine::render::mesh::MUsages::PostProcessing);
