...
impl Object {
    #[allow(dead_code)]
    pub fn new(eng: &Engine, vertices: &[f32], uv: &[f32], normals: &[f32], lenght: i32, vertexcode: &str, shadowvertexcode: &str, fragmentcode: &str, unifroms: &Vec<Uniformstruct>, texid: &str, cubeid: &str, magfilter: &str, minfilter: &str, cull_mode: &str, shcull_mode: &str, forpost: bool) -> Object{
        ...
        Object { 
            mesh: Mesh::create(&eng.ren, &jsvert, &jsuv, &jsn, &jst, lenght, vertexcode, shadowvertexcode, fragmentcode, ubol, texid, cubeid, magfilter, minfilter, cull_mode, shcull_mode, forpost),
    ...
    #[allow(dead_code)]
    pub fn new_from_obj(eng: &Engine, modelid: &str, vertexcode: &str, shadowvertexcode: &str, fragmentcode: &str, unifroms: &Vec<Uniformstruct>, texid: &str, cubeid: &str, magfilter: &str, minfilter: &str, cull_mode: &str, shcull_mode: &str, forpost: bool) -> Object{
        ...
        jst.copy_from(&tang.as_slice());
        Object { 
            mesh: Mesh::create(&eng.ren, &jsvert, &jsuv, &jsn, &jst, md.size, vertexcode, shadowvertexcode, fragmentcode, ubol, texid, cubeid, magfilter, minfilter, cull_mode, shcull_mode, forpost),
            jsarr: Float32Array::new_with_length((ubol/4) as u32),
            inuniform: 0,
            pos: Vec3::new(),
            rot: Vec3::new(),
